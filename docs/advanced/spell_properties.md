...
- **enabled**: A list of _contexts_ in which the spell is enabled. There are currently 9 contexts:
  ...
  - **treasure**: True to include this spell in loot chests, false to exclude it. If disabled, the spell will be excluded from the [random_spell loot function](/advanced/random_spell_loot_function) when used in chest loot tables.
  ...
  - **looting**: True to include this spell's book in rare mob drops, false to exclude it. If disabled, the spell will be excluded from the [random_spell loot function](/advanced/random_spell_loot_function) when used in entity loot tables.
