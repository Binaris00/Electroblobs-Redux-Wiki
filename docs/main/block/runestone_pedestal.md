...
Runestone pedestals are blocks with similar properties to stone, which are available in 7 elemental varieties and have a glowing pattern on their side faces. They serve as decorative blocks and building materials, and hold the tile entity responsible for [shrine](/main/structure/shrine) mechanics.
...
Runestone pedestal blocks appear to be made of colored stone with roughly chiseled edges. The four side faces have a T-shaped pattern, which glows in the dark - though the block itself does not emit any actual light. The colors of the stone and pattern reflect the runestone pedestal's element.
