...
They generate at the surface throughout the overworld. Normally containing some bookshelves and sometimes an [imbuement altar](/main/block/imbuement_altar) with [receptacles](/main/block/receptacle).

## Generation

By default, library ruins are rarer than [wizard towers](/main/structure/wizard_tower), making them difficult to find. They can appear in all biomes.
